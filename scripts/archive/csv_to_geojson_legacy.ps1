<#!
  Fallback/archived converter for local Windows PowerShell usage.
  Note: This version omits text normalization and extra logging used in CI.
  Usage (Windows PowerShell):
    ./scripts/archive/csv_to_geojson_legacy.ps1 -CsvPath ./data/poi.csv -OutPath ./data/poi.geojson
!>
param(
